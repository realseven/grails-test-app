...
class gsp_myapp_userindex_gsp extends GroovyPage {
...
printHtmlPart(12)
invokeTag('sortableColumn','g',27,['property':("uid"),'title':(message(code: 'user.uid.label', default: 'Uid'))],-1)
printHtmlPart(13)
invokeTag('sortableColumn','g',29,['property':("name"),'title':(message(code: 'user.name.label', default: 'Name'))],-1)
printHtmlPart(13)
invokeTag('sortableColumn','g',31,['property':("email"),'title':(message(code: 'user.email.label', default: 'Email'))],-1)
printHtmlPart(14)
loop:{
int i = 0
...
printHtmlPart(16)
createTagBody(3, {->
expressionOut.print(fieldValue(bean: userInstance, field: "uid"))
})
...
printHtmlPart(19)
invokeTag('paginate','g',50,['total':(userInstanceCount ?: 0)],-1)
printHtmlPart(20)
})
