...
class gsp_myapp_usershow_gsp extends GroovyPage {
...
printHtmlPart(13)
if(true && (userInstance?.uid)) {
printHtmlPart(14)
invokeTag('message','g',28,['code':("user.uid.label"),'default':("Uid")],-1)
printHtmlPart(15)
invokeTag('fieldValue','g',30,['bean':(userInstance),'field':("uid")],-1)
printHtmlPart(16)
}
printHtmlPart(17)
if(true && (userInstance?.name)) {
printHtmlPart(18)
invokeTag('message','g',37,['code':("user.name.label"),'default':("Name")],-1)
printHtmlPart(19)
invokeTag('fieldValue','g',39,['bean':(userInstance),'field':("name")],-1)
printHtmlPart(16)
}
printHtmlPart(17)
...
printHtmlPart(21)
invokeTag('fieldValue','g',48,['bean':(userInstance),'field':("email")],-1)
printHtmlPart(16)
}
printHtmlPart(22)
createTagBody(2, {->
...
invokeTag('link','g',56,['class':("edit"),'action':("edit"),'resource':(userInstance)],3)
printHtmlPart(24)
...
invokeTag('form','g',59,['url':([resource:userInstance, action:'delete']),'method':("DELETE")],2)
printHtmlPart(26)
})
