...
class gsp_myapp_testcreate_gsp extends GroovyPage {
...
invokeTag('eachError','g',25,['bean':(testInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',27,['bean':(testInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
...
invokeTag('form','g',35,['url':([resource:testInstance, action:'save'])],2)
printHtmlPart(22)
})
